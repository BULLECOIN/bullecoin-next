    ...
    <main className="runnerPortal">
      ...
      <section className="runnerPortalHero">
        <div className="runnerPortalHeroCopy">
          <p className="sectionLabel">OFFICIAL BULLE COMPETITION ARENA</p>
          <h1>
            BULL
            <span>RUNNER.</span>
          </h1>
        ...
        <div className="runnerPortalLeaderboard">
          ...
          {topTen.length ? (
            ...
            <div className="runnerPortalEmpty">
              No verified scores yet. Become the first ranked runner.
            </div>
          )}
        </div>
      ...
      <section id="rules" className="runnerPortalSection">
        ...
        <div className="runnerPortalRules">
          ...
          <article>
            ...
            <p>Submitted jumps are replayed against the server-generated seed.</p>
          </article>
          <article>
      ...
      <footer className="runnerPortalFooter">
        <div>
          <strong>BULLE — BULL RUNNER</strong>
          <span>bullecoin.io</span>
        </div>

        <p>
          Bull Runner is an experimental skill-based beta. Crypto assets involve
