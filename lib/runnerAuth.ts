...
export function loginMessage(wallet:string,n:string,issued:string){return ["BULLE Bear Smash","Sign this free message to verify your wallet.","This does not authorize a transaction or payment.","",`Wallet: ${wallet}`,`Nonce: ${n}`,`Issued At: ${issued}`,"Domain: bullecoin.io"].join("\n");}
